document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            const name = input.name || input.getAttribute('data-name') || 'This field';
            ...
            if (input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
                showError(input, `${name} must be at least ${input.getAttribute('minlength')} characters`);
                return false;
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'acc3dfb8-e0ae-4c2a-ae1d-d80258c7288b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'acc3dfb8-e0ae-4c2a-ae1d-d80258c7288b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'acc3dfb8-e0ae-4c2a-ae1d-d80258c7288b';
